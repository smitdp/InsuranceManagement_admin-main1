...
('a', 'a', 'a', 'a', '1234567890', 3, 3, 1),
	...
	('Siddharth', 'Saumya', 'sidpass', 'sid@test.com', '1234567890', 3, 3, 1);
...
-- Insert Claims
INSERT INTO Claims (PolicyId, UserId, IncidentDate,IncidentLocation,Address, Description,Status) VALUES
(3, 18, '2023-01-05','Patna','Home','No description',1),
(5, 18, '2023-01-05','Gandhinagar','Home','No description',1);

--Insert Claim Docs
INSERT INTO ClaimDocuments (ClaimId, DocumentPath)
VALUES 
    (1, '/documents/claim1_doc1.pdf'),
    (1, '/documents/claim1_doc2.pdf'),
    (2, '/documents/claim2_doc1.pdf'),
    (2, '/documents/claim2_doc2.pdf');


--PolicyId, UserId,IncidentDate,IncidentLocation,Address, Description,Status
...
select * from Roles;
select isActive from Users where ID=3;
...
update Claims
set status = 3
where userId = 18 and policyId = 2;
